		...
		<div>
			...
			<div className="grid lg:grid-cols-2 mt-20 gap-20">
				<div>
					...
					<p className="mt-4 mb-8 text-gray-500">强有力的工具 强有力的工具 强有力的工具 强有力的工具 强有力的工具强有力的工具</p>
					<ul className="grid gap-3">
						{[1, 2, 3].map(v => (
							<li key={v} className={`p-5 justify-between rounded border border-zinc-100 ${v === 1 && "bg-zinc-100"}`}>
								<p className="text-lg font-bold">构建简单的生态系统</p>
								<div className="flex justify-between relative">
									<p className="text-lg leading-7 mt-1">构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统</p>
									<svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 ml-8 relative -top-2">
										...
										<defs>
											<filter id="filter0_d_0_125" x="0" y="0" width="38" height="38" filterUnits="userSpaceOnUse" colorinterpolation-filters="sRGB">
