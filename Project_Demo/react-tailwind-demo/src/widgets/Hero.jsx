...
export default function Hero() {
	return (
		<div className="grid justify-items-center gap-8 pb-28 relative">
			<p className="text-4xl md:text-6xl font-black text-center leading-normal md:leading-normal">打造一个完美的、现象级的、充满创造力的网站</p>
			<p className="text-xl text-gray-700 md:w-1/2 text-center">打造一个完美的、现象级的、充满创造力的网站打造一个完美的、现象级的、充满创造力的网站打造一个完美的、现象级的、充满创造力的网站打造一个完美的、现象级的、充满创造力的网站</p>
			<div>
			...
			<div className="relative grid justify-items-center">
				<video src={Video} controls className="w-[768px] h-[432px] object-cover rounded"></video>
